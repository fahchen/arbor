defmodule CartPage.Persistence do
  @moduledoc """
  ...
  ## Examples
      ...
      CartPage.Persistence.start_link([])
      #=> {:ok, pid}
  """
  ...
  ## Examples
      ...
      CartPage.Persistence.subscribe_cart("demo-cart")
      #=> :ok
  """
  ...
  ## Examples
      ...
      CartPage.Persistence.load_cart("demo-cart")
      #=> []
  """
  ...
  ## Examples
      ...
      lines = CartPage.Persistence.update_cart("demo-cart", fn lines -> lines end)
      #=> []
  """
  ...
  ## Examples
      ...
      CartPage.Persistence.save_cart("demo-cart", [])
      #=> :ok
  """
