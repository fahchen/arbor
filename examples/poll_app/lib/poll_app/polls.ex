defmodule PollApp.Polls do
  ...
  ## Examples
      ...
      PollApp.Polls.get_detail("demo-poll")
      #=> %PollApp.PollDetail{...}
  """
  ...
  ## Examples
      ...
      PollApp.Polls.list_options("demo-poll")
      #=> [%PollApp.PollOption{...}, ...]
  """
  ...
  ## Examples
      ...
      PollApp.Polls.get_user_vote("demo-poll", "user-1")
      #=> "opt-1"
  """
  ...
  ## Examples
      ...
      PollApp.Polls.vote("demo-poll", "user-1", "opt-2")
      #=> {:ok, :voted}
  """
  @spec vote(poll_id(), user_id(), option_id()) ::
          {:ok, :voted} | {:error, :closed | :unknown_option}
  ...
  ## Examples
      ...
      PollApp.Polls.reset_vote("demo-poll", "user-1")
      #=> {:ok, :reset}
  """
  ...
  ## Examples
      ...
      PollApp.Polls.toggle_status("demo-poll")
      #=> {:ok, :closed}
  """
  ...
  defp broadcast_dashboard do
    Phoenix.PubSub.broadcast(PollApp.PubSub, "dashboard", {:dashboard_updated, list_summaries()})
  end
end
