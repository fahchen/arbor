defmodule ChatRoom.Presence do
  ...
  ## Examples
      ...
      ChatRoom.Presence.join("general", "u1", "Ada")
      #=> %ChatRoom.OnlineUser{id: "u1", name: "Ada"}
  """
  ...
  ## Examples
      ...
      ChatRoom.Presence.update_name("general", "u1", "Grace")
      #=> %ChatRoom.OnlineUser{id: "u1", name: "Grace"}
  """
  ...
  ## Examples
      ...
      ChatRoom.Presence.leave("general", "u1")
      #=> :ok
  """
  ...
  ## Examples
      ...
      ChatRoom.Presence.list("general")
      #=> []
  """
