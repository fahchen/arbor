defmodule Arbor.Page.PatchEnvelope do
  @moduledoc """
  Wire-shape of one Arbor patch update.
  ...
  ## Examples
      ...
      iex> %Arbor.Page.PatchEnvelope{base_version: 0, version: 1, ops: [%{op: "replace", path: "", value: %{}}], stream_ops: []}
      ...> |> Map.fetch!(:type)
      "patch"
  """
  ...
  @typedoc "Op shape — see `Arbor.Diff` for `ops` and `Arbor.Stream` for `stream_ops`."
  @type op() :: %{
  ...
  ## Examples
      ...
      iex> envelope = Arbor.Page.PatchEnvelope.initial(%{"title" => "Inbox"}, [])
  ...
  ## Examples
      ...
      iex> Arbor.Page.PatchEnvelope.build(0, [%{op: "replace", path: "/a", value: 1}], [])
      %Arbor.Page.PatchEnvelope{type: "patch", base_version: 0, version: 1, ops: [%{op: "replace", path: "/a", value: 1}], stream_ops: []}

      iex> Arbor.Page.PatchEnvelope.build(3, [], [])
      nil
  """
  ...
  ## Examples
      ...
      iex> envelope = %Arbor.Page.PatchEnvelope{base_version: 0, version: 1, ops: [], stream_ops: []}
      iex> Arbor.Page.PatchEnvelope.to_wire(envelope)
