defmodule Arbor.Testing do
  @moduledoc """
  Test entry point for Arbor root stores, analogous to
  `Phoenix.LiveViewTest`. Wraps `Arbor.Page.Server.start_link/1` with
  ...
  ## Example
      ...
      page = Arbor.Testing.mount(RoomStore, %{"room_code" => "AB12"})
