defmodule Arbor.Codegen.TypeScript do
  ...
  defp emit_state_node({segment, {children, leaf_entry}}, depth) do
    ...
    inner_indent = String.duplicate("  ", depth + 1)

    leaf_decl =
      case leaf_entry do
        nil -> []
        {_module, %{fields: fields}} -> render_state_interface(segment, fields, inner_indent)
      end

    children_body = if children == %{}, do: [], else: emit_state_tree(children, depth + 1)
