defmodule Arbor.Stream.Marker do
  @moduledoc false

  @key :__arbor_stream__
  @wire_key Atom.to_string(@key)

  @type marker() :: %{required(:__arbor_stream__) => String.t()}
  ...
  @typep marker_candidate() ::
           ...
           | number()
           | String.t()
           | Arbor.Stream.stream_name()

  @doc false
  @spec key() :: :__arbor_stream__
  def key, do: @key
  ...
  @doc false
  @spec new(Arbor.Stream.stream_name()) :: marker()
