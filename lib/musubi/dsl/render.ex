defmodule Musubi.DSL.Render do
  @moduledoc false
  ...
  """
  @spec stream(Musubi.Stream.stream_name()) :: Macro.t()
  ...
  The runtime reads the current `Musubi.AsyncResult` from `socket.assigns` under
  the same stream name, falling back to `Musubi.AsyncResult.loading/0` before the
  ...
  """
  @spec async_stream(Musubi.Stream.stream_name()) :: Macro.t()
