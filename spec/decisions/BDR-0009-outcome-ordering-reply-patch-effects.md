...
status: accepted
date: 2026-05-08
summary: Transport reply ships first, the patch push follows, broadcast/persist_now effects fire last. Keeps perceived command latency minimal; effects do not block client visibility.
---
